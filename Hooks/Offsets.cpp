...
namespace SPF_CabinWalk::Offsets
{
    ...
    bool Find(const SPF_Hooks_API* hooks_api)
    {
        ...
        uintptr_t update_cam_fn_address = hooks_api->FindPattern(G_UPDATE_CAMERA_FROM_INPUT_SIGNATURE);
        ...
        uintptr_t array_pattern_address = hooks_api->FindPatternFrom(G_AZIMUTH_ARRAY_AND_COUNT_PATTERN, update_cam_fn_address, 2048);
        ...
        uintptr_t interior_cam_fn_address = hooks_api->FindPattern(G_UPDATE_INTERIOR_CAMERA_SIGNATURE);
        ...
        last_pattern_addr = hooks_api->FindPatternFrom(G_START_AZIMUTH_SIGNATURE, last_pattern_addr, 200);
        ...
        last_pattern_addr = hooks_api->FindPatternFrom(G_END_AZIMUTH_SIGNATURE, last_pattern_addr, 50);
