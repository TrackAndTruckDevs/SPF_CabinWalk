...
std::unique_ptr<Animation::AnimationSequence> CreateSofaSit1ToLieSequence(const Animation::CurrentCameraState& start_state, const Animation::CurrentCameraState& target_state) {
...
std::unique_ptr<Animation::AnimationSequence> CreateSofaLieToSit2Sequence(const Animation::CurrentCameraState& start_state, const Animation::CurrentCameraState& target_state) {
  auto seq = std::make_unique<Animation::AnimationSequence>();
...
std::unique_ptr<Animation::AnimationSequence> CreateSofaSit2ToSit1Sequence(const Animation::CurrentCameraState& start_state, const Animation::CurrentCameraState& target_state) {
  auto seq = std::make_unique<Animation::AnimationSequence>();
...
std::unique_ptr<Animation::AnimationSequence> CreateSofaLieToSofa1Sequence(const Animation::CurrentCameraState& start_state, const Animation::CurrentCameraState& target_state) {
  auto seq = std::make_unique<Animation::AnimationSequence>();
...
std::unique_ptr<Animation::AnimationSequence> CreateSofaSit1ToSit2Sequence(const Animation::CurrentCameraState& start_state, const Animation::CurrentCameraState& target_state) {
  auto seq = std::make_unique<Animation::AnimationSequence>();
