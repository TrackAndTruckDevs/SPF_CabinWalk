...
std::unique_ptr<Animation::AnimationSequence> CreatePassengerToDriverSequence(const Animation::CurrentCameraState& start_state, const Animation::CurrentCameraState& target_state) {
