...
std::unique_ptr<Animation::AnimationSequence> CreateDriverToPassengerSequence(const Animation::CurrentCameraState& start_state, const Animation::CurrentCameraState& target_state) {
